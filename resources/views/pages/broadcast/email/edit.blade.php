                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ url('broadcast/email/update') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="subject" name="subject" value="{{ $response['subject'] }}"  placeholder="Masukkan Subject" required rows="4">
                                </div>
            
                                <div class="form-group">
                                    <label for="body">Body Email <span class="text-danger">*</span></label>
                                    <textarea name="body" id="default-editor" cols="10" rows="3" class="form-control tinymce-element" placeholder="Masukan Pesan email">{{ $response['body'] }}</textarea>
                                </div>
            
                                <div class="form-group">
                                    <label for="brief_description">Sender Email</label>
                                    <input type="email" class="form-control" id="sender" name="sender"  placeholder="Email Sender" value="{{ $response['sender'] }}" rows="4">
                                </div>
